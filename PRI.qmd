...
fellow <- read.csv("https://raw.githubusercontent.com/omcrouse/research/main/Fellow.csv")
```
...
Political Risk Insurance <br> for <br> Canadian Oil and Gas Companies
...
This idea came about because of **COVID-19**. Did the market lose money? Could that loss of money been recuperated through political influence or an insurance program? This paper seeks to show what difference would have been through either of the major political parties having majority control.
...
The following years were observed to look at elections from 1998 to 2021 from the website directly from the Parliament of Canada. This was to determine which parties were elected to the majority and the probability of those parties. The probabilities were found from various polling firms. From these polls, the data taken was only pertaining to the liberal and conservative parties. The other parties were left out as to they did provide a significant impact.

Each year that falls in-between elections were tracked by the business cycle for Canada, whether the aggregate of each year individually was an expansion year or contraction year. Although the business cycle fluctuates more within a year, the aggregate for the whole year was used as this influences voting more so. This data was found from FRED.
